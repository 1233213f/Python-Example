...
def get_num(url):
    ...
    doc_url = "https://wenku.baidu.com/view/" + url[29:-5]  # 网页的前缀
    n = 0
...
if __name__ == '__main__':
    url = "https://wenku.baidu.com/view/0f4fe8f4d3f34693daef5ef7ba0d4a7302766cae.html?fr=search-income1-psrec1&fixfr=pN4OGF496B9dJw%2Fekv5S4Q%3D%3D"
    get_num(url)
